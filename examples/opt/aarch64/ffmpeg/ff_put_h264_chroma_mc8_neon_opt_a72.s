...
// General (full bilinear) path only.  Preamble outside loop:
        ...
        umull v21.8H, v4.8B, v0.8B            // *.............................
        umlal v21.8H, v5.8B, v1.8B            // .*............................
        ld1 {v4.8B, v5.8B}, [x1], x2          // ......*.......................
...
loop_start:
                                              ...
                                              // 0                        25
                                              // |------------------------|----
        ext v23.8B, v10.8B, v11.8B, #1        // *.............................
        subs w3, w3, #2                       // *............................. // @slothy:id=cmp
        umlal v21.8H, v10.8B, v2.8B           // *.............................
        umull v8.8H, v10.8B, v0.8B            // .*............................
        ext v5.8B, v4.8B, v5.8B, #1           // ..*...........................
        ld1 {v10.8B, v11.8B}, [x1], x2        // ..e...........................
        umlal v21.8H, v23.8B, v3.8B           // ...*..........................
        umlal v8.8H, v23.8B, v1.8B            // ....*.........................
        rshrn v27.8B, v21.8H, #6              // ....*.........................
        umlal v8.8H, v4.8B, v2.8B             // .....*........................
        umlal v8.8H, v5.8B, v3.8B             // ......*.......................
        rshrn v23.8B, v8.8H, #6               // .......*......................
        umull v21.8H, v4.8B, v0.8B            // .......e......................
        umlal v21.8H, v5.8B, v1.8B            // ........e.....................
        ...
        b.gt loop_start
                                              ...
                                              // 0                        25
                                              // |------------------------|----
        ext v26.8B, v10.8B, v11.8B, #1        // *.............................
        subs w3, w3, #2                       // *.............................
        umlal v21.8H, v10.8B, v2.8B           // *.............................
        umull v22.8H, v10.8B, v0.8B           // .*............................
        ext v5.8B, v4.8B, v5.8B, #1           // .*............................
        umlal v21.8H, v26.8B, v3.8B           // ...*..........................
        umlal v22.8H, v26.8B, v1.8B           // ....*.........................
        rshrn v23.8B, v21.8H, #6              // ....*.........................
        umlal v22.8H, v4.8B, v2.8B            // .....*........................
        umlal v22.8H, v5.8B, v3.8B            // ......*.......................
        rshrn v17.8B, v22.8H, #6              // .......*......................
        st1 {v23.8B}, [x0], x2                // ........*.....................
        st1 {v17.8B}, [x0], x2                // ...........*..................
