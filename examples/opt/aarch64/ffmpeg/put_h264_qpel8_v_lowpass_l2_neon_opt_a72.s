...
// v6.h[0]=5, v6.h[1]=20  -- lowpass_const, set by caller
        ...
        urhadd v9.8B, v20.8B, v9.8B          // ............................................*.....................................
        mla v22.8H, v3.8H, v6.H[1]           // ............................................*.....................................
        sqrshrun v20.8B, v8.8H, #5           // .............................................*....................................
        ld1 {v8.8B}, [x1], x3                // .............................................*....................................
        uaddl v5.8H, v5.8B, v7.8B            // ..............................................*...................................
        mls v22.8H, v2.8H, v6.H[0]           // ..............................................*...................................
        st1 {v9.8B}, [x0], x3                // ...............................................*..................................
        uaddl v9.8H, v25.8B, v7.8B           // ...............................................*..................................
        uaddl v3.8H, v14.8B, v7.8B           // ................................................*.................................
        urhadd v20.8B, v10.8B, v20.8B        // .................................................*................................
        mla v5.8H, v23.8H, v6.H[1]           // .................................................*................................
        uaddl v10.8H, v21.8B, v8.8B          // ..................................................*...............................
        ld1 {v21.8B}, [x1], x3               // ..................................................*...............................
        mls v5.8H, v24.8H, v6.H[0]           // ...................................................*..............................
        sqrshrun v22.8B, v22.8H, #5          // ...................................................*..............................
        st1 {v20.8B}, [x0], x3               // ....................................................*.............................
        uaddl v20.8H, v13.8B, v8.8B          // ....................................................*.............................
        mla v10.8H, v12.8H, v6.H[1]          // .....................................................*............................
        uaddl v24.8H, v7.8B, v8.8B           // .....................................................*............................
        urhadd v4.8B, v4.8B, v22.8B          // .......................................................*..........................
        uaddl v22.8H, v25.8B, v21.8B         // .......................................................*..........................
        ld1 {v25.8B}, [x1], x3               // .......................................................*..........................
        mls v10.8H, v9.8H, v6.H[0]           // ........................................................*.........................
        sqrshrun v9.8B, v5.8H, #5            // ........................................................*.........................
        uaddl v8.8H, v8.8B, v21.8B           // .........................................................*........................
        mla v22.8H, v3.8H, v6.H[1]           // ..........................................................*.......................
        uaddl v5.8H, v14.8B, v21.8B          // ..........................................................*.......................
        st1 {v4.8B}, [x0], x3                // ..........................................................*.......................
        urhadd v9.8B, v28.8B, v9.8B          // ............................................................*.....................
        uaddl v4.8H, v13.8B, v25.8B          // ............................................................*.....................
        ld1 {v28.8B}, [x1]                   // ............................................................*.....................
        mls v22.8H, v20.8H, v6.H[0]          // .............................................................*....................
        sqrshrun v20.8B, v10.8H, #5          // .............................................................*....................
        uaddl v10.8H, v7.8B, v25.8B          // ..............................................................*...................
        mla v4.8H, v24.8H, v6.H[1]           // ...............................................................*..................
        st1 {v9.8B}, [x0], x3                // ...............................................................*..................
        uaddl v9.8H, v14.8B, v28.8B          // ................................................................*.................
        urhadd v20.8B, v15.8B, v20.8B        // .................................................................*................
        mls v4.8H, v5.8H, v6.H[0]            // .................................................................*................
        sqrshrun v22.8B, v22.8H, #5          // ..................................................................*...............
        mla v9.8H, v8.8H, v6.H[1]            // ...................................................................*..............
        st1 {v20.8B}, [x0], x3               // ....................................................................*.............
        mls v9.8H, v10.8H, v6.H[0]           // .....................................................................*............
        sqrshrun v20.8B, v4.8H, #5           // ......................................................................*...........
        urhadd v8.8B, v26.8B, v22.8B         // .......................................................................*..........
        urhadd v20.8B, v0.8B, v20.8B         // ..........................................................................*.......
        st1 {v8.8B}, [x0], x3                // ..........................................................................*.......
        sqrshrun v9.8B, v9.8H, #5            // ..........................................................................*.......
        st1 {v20.8B}, [x0], x3               // .............................................................................*....
        urhadd v9.8B, v11.8B, v9.8B          // ..............................................................................*...
        st1 {v9.8B}, [x0], x3                // .................................................................................*
